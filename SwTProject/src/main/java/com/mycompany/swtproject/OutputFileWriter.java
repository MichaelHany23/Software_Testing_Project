...
public class OutputFileWriter {
    ...
    public void WriteFirstError(ArrayList<String> results) {
        ...
        try {
            // can set the append mode to false instead of cleanfile calling
    ...
    /*
     * public void WriteRecommendations(User U , ArrayList<String>
     * recommendedTitles)
     * {
     * 
     * try
     ...
     * }
     * writer.write(recommendedTitles.getLast()); // without the comma for laaast
     * element !
     * 
     * 
     * writer.newLine();
